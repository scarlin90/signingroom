  ...
  template: `
    <div class="max-w-6xl mx-auto text-center pt-24 px-6 relative">
      ...
      <div class="flex flex-col sm:flex-row items-center justify-center gap-4 relative z-10">
        ...
        <a href="/webcomponent-demo" target="_blank"  class="px-8 py-4 rounded-lg bg-slate-800/80 hover:bg-slate-700 text-white font-medium transition-all flex items-center gap-2 border border-slate-700 hover:border-slate-600 w-full sm:w-auto justify-center">

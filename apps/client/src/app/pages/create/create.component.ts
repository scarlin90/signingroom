...
import { 
  ...
  X, UploadCloud, FileJson, AlertTriangle, Shield, Key
} from 'lucide-angular';
...
@Component({
  ...
  template: `
    <div class="min-h-screen bg-slate-950 text-white flex flex-col items-center pt-32 p-6 relative">
      ...
      <div class="w-full relative z-10 flex justify-center max-w-xl"> 
        <div class="bg-slate-900/50 backdrop-blur-sm border border-slate-800 rounded-2xl p-8 flex flex-col hover:border-emerald-500/30 transition-all group w-full shadow-2xl">
            ...
            <div class="flex items-center gap-5 mb-8">
                ...
                <div>
                    <h3 class="text-2xl font-bold text-white tracking-tight">Signing Room®</h3>
